...
async def upload_dataset(file: UploadFile = File(...), ds_svc: DatasetService = Depends(get_dataset_service)):
...
async def delete_dataset(dataset_id: str, ds_svc: DatasetService = Depends(get_dataset_service)):
